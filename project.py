...
def newRestaurant():
    # TODO maybe keep a userid file and check that there is
    # an active user that is in the userid file.
    # would need to check each time we do something that makes
